...
export const removeAllUsers = async () => {
  ...
  for (const user of data) {
    ...
    if (truncateError) {
      console.error("Error truncating 'users' table:", truncateError.message);
    }
  }
};
...
export const removeAllGroups = async () => {
  ...
  for (const group of groups) {
    ...
    if (truncateError) {
      console.error("Error truncating 'groups' table:", truncateError.message);
    }
  }
};
...
export const removeAllSongs = async () => {
  ...
  for (const song of songs) {
    ...
    if (truncateError) {
      console.error("Error truncating 'songs' table:", truncateError.message);
    }
  }
};
